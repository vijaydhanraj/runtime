...
func (a *acrn) appendImage(devices []Device) ([]Device, error) {
...
func (a *acrn) buildDevices(initrdPath string) ([]Device, error) {
	var devices []Device
...
func (a *acrn) createdummyVirtiBlkDev(devices []Device) ([]Device, error) {
	...
	for driveIndex := 0; driveIndex < AcrnBlkDevPoolSz; driveIndex++ {
		/*
